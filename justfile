...
translation-extract:
    @just pybabel " \
        extract \
            --omit-header \
            --sort-by-file \
            --output 'src/test_gh_rtd_mit_or_apache_2_0_macos_311/locale/base.pot' \
            src \
    "
...
translation-init locale:
    @just pybabel " \
        init \
            --input-file 'src/test_gh_rtd_mit_or_apache_2_0_macos_311/locale/base.pot' \
            --output-dir 'src/test_gh_rtd_mit_or_apache_2_0_macos_311/locale' \
            --locale='{{ locale }}' \
    "
