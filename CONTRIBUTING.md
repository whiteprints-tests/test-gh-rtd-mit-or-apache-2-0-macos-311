...
To report identified bugs, please fill a.[GitHub bug report issue](https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-macos-311/issues/new?template=bug_report.yml).
...
To request features, please [open a discussion](https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-macos-311/discussions/categories/ideas)

Once the enhancement has been discussed, fill a [GitHub feature issue](https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-macos-311/issues/new?template=feature_request.yml).
...
Your contribution needs to meet the following guidelines for acceptance:
  ...
  - Include unit tests; this project maintains [100% code coverage](https://codecov.io/gh/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-macos-311).
...
[Pull Request]: https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-macos-311/pulls
[issue]: https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-macos-311/issues
