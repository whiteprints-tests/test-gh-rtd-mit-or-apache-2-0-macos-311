...
project = "test gh-rtd mit-or-apache-2-0 macos 3.11"
...
release = metadata.version("test_gh_rtd_mit_or_apache_2_0_macos_311")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "ReadTheDocs",
            "url": "https://readthedocs.org/projects/test-gh-rtd-mit-or-apache-2-0-macos-311",
        ...
        },
        {
            ...
            "url": (
                "https://github.com/"
                "whiteprints-tests/"
                "test-gh-rtd-mit-or-apache-2-0-macos-311"
            ),
