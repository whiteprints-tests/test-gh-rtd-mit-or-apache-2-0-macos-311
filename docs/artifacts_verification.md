...
```console
gh attestation verify <path_to_the_release_artifact> --repo whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-macos-311
```
...
cosign verify-blob \
    ...
    --certificate-identity-regexp="^https://github.com/whiteprints-tests/test-gh-rtd-mit-or-apache-2-0-macos-311/.github/workflows/upload_artifacts.yml?" \
